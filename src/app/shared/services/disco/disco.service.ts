...
export class DiSCOService {
    ...
    private mineUrl = `${environment.serviceUrl}/api/queries/selectDiscosByOwnerId?researcherId=`
	  private mineCollectUrl = `${environment.serviceUrl}/api/queries/selectDiscosByCollectorId?researcherId=`
